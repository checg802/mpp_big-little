...
EXTERN DLL int dp_register_second_device_cb(dp_second_blob_outresult_back_cb_t cb, void *param);
...
* \returns 0 if sucess, <0 if error occured.
*/
EXTERN DLL int dp_register_send_to_box_device_cb(dp_send_to_device_box_cb_t cb, void *param);
