...
//        stViDevAttr.stDevRect.s32X = 8;
	...
	case SONY_IMX326_LVDS_5M_30FPS:
		memcpy(&stViDevAttr, &DEV_ATTR_LVDS_BASE, sizeof(stViDevAttr));
		stViDevAttr.stDevRect.s32X = 0;
		stViDevAttr.stDevRect.s32Y = 0;
		stViDevAttr.stDevRect.u32Width	= 2592;
...
HI_S32 SAMPLE_COMM_VI_SetMipiAttr(COMBO_DEV MipiDev, SAMPLE_VI_CONFIG_S* pstViConfig)
{
	...
	else if (pstViConfig->enViMode == SONY_IMX326_LVDS_5M_30FPS)
    {
        pstcomboDevAttr = &LVDS_6lane_SENSOR_IMX326_12BIT_5M_NOWDR_ATTR;
    }
//lxcadd
    else if (pstViConfig->enViMode == SONY_IMX185_MIPI_1080P_30FPS)
    {
		pstcomboDevAttr = &MIPI_4lane_SENSOR_IMX185_12BIT_ATTR;
//		pstcomboDevAttr = &LVDS_6lane_SENSOR_IMX274_12BIT_8M_NOWDR_ATTR;
//		pstcomboDevAttr = &MIPI_3516_4lane_SENSOR_IMX185_12BIT_ATTR;    
//		pstcomboDevAttr = &MIPI_CMOS3V3_ATTR;   
//		pstcomboDevAttr = &LVDS_6lane_SENSOR_IMX185_12BIT_8M_NOWDR_ATTR;
    }
//lxcend
...
HI_S32 SAMPLE_COMM_VI_StartIspAndVi(SAMPLE_VI_CONFIG_S* pstViConfig)
{
 ...
 SAMPLE_PRT("step 2222222222222222222222222: mipi configured!\n");       
        s32Ret = SAMPLE_COMM_ISP_Sensor_Regiter_callback(IspDev, u32SnsId);
//lxc		sensor_register_callback();
        if (HI_SUCCESS != s32Ret)
        {
 ...
 SAMPLE_PRT("step 333333333333333333333333333333: mipi configured!\n");       
...
SAMPLE_PRT("************step 3: run isp thread!\n");       
    /******************************************
...
SAMPLE_PRT("************step 4: config & start vicap dev!\n");  
    /******************************************************
...
SAMPLE_PRT("************step 5: config & start vicap chn (max 1)! u32ChnNum = %d \n",u32ChnNum);
    /******************************************************
...
SAMPLE_PRT("HI_MPI_VI_DisableChn succeed with %#x\n", s32Ret);
    }
...
SAMPLE_PRT("HI_MPI_VI_DisableDev succeed with %#x\n", s32Ret);
    }
