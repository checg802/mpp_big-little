...
{
    printf("press select vo as follows!\n");
    printf("index:\n");
    printf("\t 0) vo cvbs output.\n");
    printf("\t 1) vo BT1120 output.\n");
	printf("\t other) default vo cvbs output.\n");
	printf("select vo device command:");
    return;
}
...
#endif
{
	...
	if (SelDev == '1')  /* '0': VO_INTF_CVBS, else: BT1120 */
	#else
