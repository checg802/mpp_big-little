...
HI_S32 SAMPLE_VENC_NORMALP_CLASSIC(HI_VOID)
{
	...
	SAMPLE_PRT(" 1_0: init sys variable  \n");
    /******************************************
    ...
    ******************************************/
	...
	SAMPLE_PRT(" 1_2: init sys variable  \n");
	...
	SAMPLE_PRT(" 1_3: init sys variable  \n");
	...
	if(s32ChnNum >= 2)
    {
	SAMPLE_PRT(" 1_4: init sys variable  \n");
	    u32BlkSize = SAMPLE_COMM_SYS_CalcPicVbBlkSize(gs_enNorm,\
...
SAMPLE_PRT(" 2_0: mpp system init.  \n");
    /******************************************
     step 2: mpp system init. 
    ******************************************/
    s32Ret = SAMPLE_COMM_SYS_Init(&stVbConf);
SAMPLE_PRT(" 2_1: mpp system init.  \n");
    if (HI_SUCCESS != s32Ret)
    {
SAMPLE_PRT(" 2_3: mpp system init.  \n");
        SAMPLE_PRT("system init failed with %d!\n", s32Ret);
        goto END_VENC_1080P_CLASSIC_0;
    }

SAMPLE_PRT(" 3_0: start vi dev & chn to capture.  \n");
    /******************************************
...
SAMPLE_PRT(" 3_1: start vi dev & chn to capture.  \n");
    if (HI_SUCCESS != s32Ret)
    {
SAMPLE_PRT(" 3_2: start vi dev & chn to capture.  \n");
        SAMPLE_PRT("start vi failed!\n");
        goto END_VENC_1080P_CLASSIC_1;
    }
    
SAMPLE_PRT(" 4_0: start vpss and vi bind vpss.  \n");
    /******************************************
     step 4: start vpss and vi bind vpss
    ******************************************/
    s32Ret = SAMPLE_COMM_SYS_GetPicSize(gs_enNorm, enSize[0], &stSize);
SAMPLE_PRT(" 4_1: start vpss and vi bind vpss.  \n");
    if (HI_SUCCESS != s32Ret)
    {
SAMPLE_PRT(" 4_2: start vpss and vi bind vpss.  \n");
        SAMPLE_PRT("SAMPLE_COMM_SYS_GetPicSize failed!\n");
        goto END_VENC_1080P_CLASSIC_1;
    }

SAMPLE_PRT(" 4_3: start vpss and vi bind vpss.  \n");
    if(s32ChnNum >= 1)
    {
	    VpssGrp = 0;
